...
public class Start {
	...
	public Start() {
		...
		// ca.setDescription("Infos%20von%20undfuer" +
		...
		// ca2.setDescription("Infos%20von%20undfuer" +
		// loggedInUser.getGivenName());
		...
		// ca3.setDescription("Infos%20von%20undfuer" +
		// loggedInUser.getGivenName());
		...
		//
		// System.out.println("Request calendar of " +
		// loggedInUser.getGivenName());
		// List<Integer> caIDs = loggedInUser.getCalendarIds();
		// int caID = -1;
		// if(caIDs.isEmpty()){
		// System.err.println("Error: No CalendarID was found in User-Object of "
		// +loggedInUser.getGivenName());
		// return;
		// }else{
		// caID = caIDs.get(0);
		...
		// }else{
		// room = rooms.get(0);
		// System.out.println("Rooms were found: Select room with ID " +
		// room.getID());
		// }
		//
		...
		// requester.requestAllObjectsByProperty(room1Entry);
		...
		//
		// System.out.println("Request Calendar of " +
		// loggedInUser.getMailAddress());
		// Calendar ca4 = new Calendar();
		//
		// if(loggedInUser.getCalendarIds().isEmpty()){
		// System.out.println("ERROR: no calendar for "
		// +loggedInUser.getMailAddress());
		// }else{
		// ca4.setID(loggedInUser.getCalendarIds().get(0));
		// ca4 = requester.requestObjectByOwnId(ca4);
		// if(ca4 == null){
		// System.out.println("ERROR: Calendar mit ID "
		// +loggedInUser.getCalendarIds().get(0) + " does not exist");
		// return;
		// }
		// System.out.println("Picked Calendar with ID " + ca4.getID()
		// +" and name " +ca4.getName());
		// }
		...
		// entry.getStartHour()+":"+entry.getStartMinute());
		// System.out.println("\tEnd: " +
		// entry.getEndHour()+":"+entry.getEndMinute());
		...
		// requester.declineInvite(tmp));
		// // }
		// // }
		//
		// if(!rooms.isEmpty()){
		// System.out.println("Remove Room " + rooms.get(0).getID());
		// boolean resultRemoveRoom =
		// requester.removeObjectByOwnId(rooms.get(0));
		...
		// System.out.println("Remove Calendar with ID "+calendarIDCurrentUser+" of "
		// + loggedInUser.getMailAddress());
		// System.out.println("Result: " +
		// requester.removeObjectByOwnId(calendarToRemove));
		// }
		// }
		//
		// System.out.println("Remove user " + loggedInUser.getMailAddress());
		// boolean resultRemoveUser =
		// requester.removeObjectByOwnId(loggedInUser);
